...
from src.application.models.section_models import Queries, Sections, SectionState
from src.application.prompts.research_prompts import (
...
class GenerateReportsNode:
    ...
    async def generate_report_plan(self, state: ReportState, config: RunnableConfig):
        ...
        system_instructions_sections = report_planner_instructions.format(
            topic=topic, report_organization=report_structure, context=source_str
        )
    ...
    def write_final_sections(self, state: SectionState):
        ...
        section_content = self.llm_model.invoke(
