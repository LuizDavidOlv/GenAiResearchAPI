...
from application.agents.deep_research_agent.prompts.supervisor_prompts import (
    SUPERVISOR_PROMPT,
)
from src.application.agents.deep_research_agent.research_agent import DeepResearchAgent
                ...
                if conduct_research_calls:
                    ...
                    research_tool_messages = [
                        ...
                        for result, tool_call in zip(
                            tool_results, conduct_research_calls
                        )
                    ]
